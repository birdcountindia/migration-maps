...
migrationmap = function(Species1,SciName, rawpath1, rawpath2=NA, 
                        rawpathPhoto, 
                        impos,grpos,
                        credit_color = "black")
{
...
# green colour scheme
### THIS CAN BE INCORPORATED IN ABOVE, WHERE THEME CAN BE TAKEN FROM SPEC PHOTO INFO

migrationmapgreen = function(Species1,SciName, rawpath1, rawpath2=NA, 
                             rawpathPhoto,
...
migrationmapS = function(Species1,SciName, rawpath1, rawpath2=NA, 
                         rawpathPhoto, 
                         namepos = "centre",
                         ggp,credit,
                         impos,grpos, 
